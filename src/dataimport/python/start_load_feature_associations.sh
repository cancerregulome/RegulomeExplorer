...
method="RFACE"
dataset_label=$dataset_label"_"$method
echo read in $dataset_label dataimport settings with $config_file $(date) re target instance $re_instance comments $comments desc $description
