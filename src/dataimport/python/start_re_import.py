...
def buildMeta(meta_file, config_file):
	...
	update_re_store_cmd = python_bin + ' update_rgex_dataset.py %s %s %s %s "%s" "%s" "%s" %s %s %s %s %s' %(dslabel, afm, associations, dm_method, source, description, comment, config_file, resultsPath, dsdate, diseaseCode, contact)
