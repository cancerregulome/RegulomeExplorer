...
CREATE INDEX #REPLACE#_pw_rhoscore ON mv_#REPLACE#_feature_networks(rho_score);
CREATE INDEX #REPLACE#_pw_composite1 ON mv_#REPLACE#_feature_networks(f2source, logged_pvalue);
